...
export const Card = memo(function ({ src, photographer, name }: CatalogTypes) {
  return (
    <div className="min-h-[300px] w-1/3 flex flex-col justify-between rounded-t-[5px] cursor-pointer bg-white mb-4 break-inside-avoid overflow-x-hidden shadow-lg">
